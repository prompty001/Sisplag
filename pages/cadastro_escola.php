...
<body>
    ...
    <div class=schoolForm>
        <div class=formPersonalData>
            ...
            <form class="formPersonalDataInput" action="../index.php" method="get">

                <select >
                    <option value="sigla">Tipo Escola</option>
                ...
                <input type="text" class="allInput name" value="nome_escola" name="name" placeholder="Nome da Escola">
                <input type="text" class="allInput foundation" value="fundacao" name="foundation" placeholder="Fundação"><br>
                <input type="text" class="allInput inepCode" value="codigo_inep" name="inepCode" placeholder="Código INEP">
                <input type="text" class="allInput cnpjSchool" value="cnpj_escola" name="cnpjSchool" placeholder="CNPJ"><br>
                <input type="text" class="allInput maintEntity" value="entidade_mantenedora" name="maintEntity" placeholder="Entidade Mantenedora">
                <input type="text" class="allInput cnpjCouncil" value="cnpj_conselho" name="cnpjCouncil" placeholder="CNPJ/Conselho Escolar"><br>
                <input type="text" class="allInput validityCouncil" value="vigencia_ce" name="validityCouncil" placeholder="Vigência CE">
                <input type="text" class="allInput city" value="cidade" name="city" placeholder="Cidade"><br>
                <input type="text" class="allInput uf" value="uf" name="uf" placeholder="UF"><br>
                <input type="text" class="allInput address" value="complemento" name="address" placeholder="Endereço">
                <input type="text" class="allInput neighborhood" value="bairro" name="neighborhood" placeholder="Bairro"><br>
                <input type="text" class="allInput cep" value="cep_escola" name="cep" placeholder="CEP">
                <input type="text" class="allInput phone" value="telefone_inst" name="phone" placeholder="Telefone"><br>
                <input type="email" class="allInput emailInst" value="email_inst" name="emailInst" placeholder="Email Institucional"><br>
                <input type="text" class="allInput managerName" value="nome_gesto" name="managerName" placeholder="Diretor(a)">
                <input type="text" class="allInput managerWpp" value="whats_gestor" name="managerWpp" placeholder="Whatsapp"><br>
                <input type="email" class="allInput email" value="email_gestor" name="email" placeholder="Email"><br>
                <input type="text" class="allInput secretaryName" value="nome_secretario" name="secretaryName" placeholder="Secretário(a)">
                <input type="text" class="allInput secretaryWpp" value="whats_secretario" name="secretaryWpp"placeholder="Whatsapp"><br>
                <input type="email" class="allInput secretaryEmail" value="email_secretario" name="secretaryEmail" placeholder="Email"><br>
                <input type="text" class="allInput coordinator" value="nome_coordenador" name="coordinator" placeholder="Coordenador(a)">
                <input type="text" class="allInput coordinatorWpp" value="whats_coordenador" name="coordinatorWpp" placeholder="Whatsapp"><br>
                <input type="text" class="allInput coordinatorEmail" value="email_coordenador" name="coordinatorEmail" placeholder="Email">
