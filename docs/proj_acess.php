         ...
         if(isset($_FILES['arquivo'])){
            ...
            if($arquivo['size'] > 3097152){
             ...
             if($certo){
                ...
                $inseriDoc = Conexao::conectar()->prepare("UPDATE DOCUMENTO SET proj_acess = ? WHERE fk_instituicao=$fk_instituicao");
    ...
    <div class=schoolForm>
        ...
        <div>
            ...
            <div class="input-group mb-3">
                <label class="input-group-text" for="inputGroupFile01">Projeto com Promoção de Acessibilidade</label>
